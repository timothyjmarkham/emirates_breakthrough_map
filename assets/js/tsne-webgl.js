...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'Emirates|Qatar|Etihad';
...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    brandCounts = [
    {x: "Emirates", value: brandCountsHolder["Emirates"]},
    {x: "Qatar", value: brandCountsHolder["Qatar"]},
    {x: "Etihad", value: brandCountsHolder["Etihad"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x + 28120)/(36480 + 28120)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y + 18592)/(22320 + 18592)) * 193) - marker.Height;
    ...
    clusterCounts = [
    {x: "Emirates", value: thisClusterData["Emirates"]},
    {x: "Qatar", value: thisClusterData["Qatar"]},
    {x: "Etihad", value: thisClusterData["Etihad"]}
    ]
...
mapSprite.src = "assets/images/Emirates Full Map.png";
